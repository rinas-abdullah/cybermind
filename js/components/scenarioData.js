...
export const scenarios = [
  {
    ...
    difficulty: "beginner",
    skillTags: ["phishing", "email-security", "social-engineering"],
  ...
  {
    id: "public-wifi-security-update",
    title: "📶 Free Public Wi-Fi",
    difficulty: "beginner",
    skillTags: ["network-security", "public-wifi", "malware-awareness"],
    riskType: "malware-delivery",
    description:
  ...
  {
    id: "usb-baiting-attack",
    title: "💾 USB on the Ground",
    difficulty: "intermediate",
    skillTags: ["physical-security", "usb-attacks", "malware-awareness"],
    riskType: "baiting",
    description:
  ...
  {
    id: "password-sharing-request",
    title: "🔐 Password Sharing",
    difficulty: "beginner",
    skillTags: ["access-control", "password-security", "policy-awareness"],
    riskType: "credential-misuse",
    description:
  ...
  {
    id: "suspicious-attachment-invoice",
    title: "📂 Suspicious Attachment",
    difficulty: "beginner",
    skillTags: ["email-security", "attachments", "malware-awareness"],
    riskType: "malware-delivery",
    description:
